...
unsigned char _ux_system_endpoint_descriptor_structure[] =                          {1,1,1,1,2,1 };
unsigned char _ux_system_device_descriptor_structure[] =                            {1,1,2,1,1,1,1,2,2,2,1,1,1,1};
unsigned char _ux_system_configuration_descriptor_structure[] =                     {1,1,2,1,1,1,1,1};
unsigned char _ux_system_interface_descriptor_structure[] =                         {1,1,1,1,1,1,1,1,1};
unsigned char _ux_system_interface_association_descriptor_structure[] =             {1,1,1,1,1,1,1,1};
unsigned char _ux_system_string_descriptor_structure[] =                            {1,1,2};
unsigned char _ux_system_dfu_functional_descriptor_structure[] =                    {1,1,1,2,2,2};
unsigned char _ux_system_class_audio_interface_descriptor_structure[] =             {1,1,1,1,1,1,1,1};
unsigned char _ux_system_class_audio_input_terminal_descriptor_structure[] =        {1,1,1,1,2,1,1,2,1,1};
unsigned char _ux_system_class_audio_output_terminal_descriptor_structure[] =       {1,1,1,1,2,1,1,1};
unsigned char _ux_system_class_audio_feature_unit_descriptor_structure[] =          {1,1,1,1,1,1,1};
unsigned char _ux_system_class_audio_streaming_interface_descriptor_structure[] =   {1,1,1,1,1,1};
unsigned char _ux_system_class_audio_streaming_endpoint_descriptor_structure[] =    {1,1,1,1,1,1};
unsigned char _ux_system_hub_descriptor_structure[] =                               {1,1,1,2,1,1,1,1};
unsigned char _ux_system_hid_descriptor_structure[] =                               {1,1,2,1,1,1,2};
unsigned char _ux_system_class_pima_storage_structure[] =                           {2,2,2,4,4,4,4,4};
unsigned char _ux_system_class_pima_object_structure[] =                            {4,2,2,4,2,4,4,4,4,4,4,4,2,4,4};
unsigned char _ux_system_ecm_interface_descriptor_structure[] =                     {1,1,1,1,4,2,2,1};

unsigned char _ux_system_bos_descriptor_structure[] =                               {1,1,2,1};
unsigned char _ux_system_usb_2_0_extension_descriptor_structure[] =                 {1,1,1,4};
unsigned char _ux_system_container_id_descriptor_structure[] =                      {1,1,1,1,4,4,4,4};
...
unsigned long               memory_pool_offset;
    ...
    _ux_system_host =  (UX_SYSTEM_HOST *) (((unsigned char *) regular_memory_pool_start) + memory_pool_offset);

    /* Add to the memory offset the size of the allocated block.  */
    memory_pool_offset += (unsigned long)sizeof(UX_SYSTEM_HOST);
    ...
    _ux_system_slave =  (UX_SYSTEM_SLAVE *) (((unsigned char *) regular_memory_pool_start) + memory_pool_offset);

    /* Add to the memory offset the size of the allocated block.  */
    memory_pool_offset += (unsigned long)sizeof(UX_SYSTEM_SLAVE);
    ...
    _ux_system_otg =  (UX_SYSTEM_OTG *) (((unsigned char *) regular_memory_pool_start) + memory_pool_offset);

    /* Add to the memory offset the size of the allocated block.  */
    memory_pool_offset += (unsigned long)sizeof(UX_SYSTEM_OTG);
#endif


    /* Set the cache safe memory for the dynamic pool */
    _ux_system -> ux_system_regular_memory_pool_start =  (UX_MEMORY_BLOCK *) (((unsigned char *) regular_memory_pool_start)
                                                            + memory_pool_offset);
    ...
    regular_memory_pool_end =  (void *) (((unsigned char *) regular_memory_pool_start) + regular_memory_size);
    ...
    _ux_system -> ux_system_regular_memory_pool_size =     (unsigned long) (((ALIGN_TYPE) regular_memory_pool_end) - int_memory_pool_start);
    ...
    memory_block -> ux_memory_block_size =     _ux_system -> ux_system_regular_memory_pool_size - (unsigned long)sizeof(UX_MEMORY_BLOCK);
    ...
    else
    {
        ...
        memory_block -> ux_memory_block_size =     _ux_system -> ux_system_cache_safe_memory_pool_size - (unsigned long)sizeof(UX_MEMORY_BLOCK);
        memory_block -> ux_memory_block_status =   UX_MEMORY_UNUSED;
    }

#ifdef UX_ENABLE_MEMORY_STATISTICS
    _ux_system -> ux_system_regular_memory_pool_base = (unsigned char *) _ux_system -> ux_system_regular_memory_pool_start;
    _ux_system -> ux_system_regular_memory_pool_min_free = _ux_system -> ux_system_regular_memory_pool_free;
    _ux_system -> ux_system_cache_safe_memory_pool_base = (unsigned char *) _ux_system -> ux_system_cache_safe_memory_pool_start;
